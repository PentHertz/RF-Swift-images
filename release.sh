...
DRYRUN="false"
DEV_REGISTRY="${DEV_REGISTRY:-penthertz/rfswiftdev_noble}"
RELEASE_REGISTRY="${RELEASE_REGISTRY:-penthertz/rfswift_noble}"

VALID_IMAGES="corebuild sdrsa_devices sdr_light sdr_full automotive reversing rfid network wifi bluetooth hardware telecom_utils telecom_2Gto3G telecom_4G_5GNSA telecom_5G deeptempest"
# Topological order (each image builds FROM an earlier one). Used for `all`.
ALL_IMAGES="corebuild sdrsa_devices sdr_light sdr_full reversing rfid automotive network wifi bluetooth hardware deeptempest telecom_utils telecom_2Gto3G telecom_4G_5GNSA telecom_5G"
